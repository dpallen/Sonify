...
public class SoundPlayer extends JComponent {
            ...
            InvalidMidiDataException
    {
        ...
        player = new SoundPlayer(file, ismidi, 0);
    ...
    public SoundPlayer(File f, boolean isMidi, int programChange)
            throws IOException,
            UnsupportedAudioFileException,
            LineUnavailableException,
            MidiUnavailableException,
            InvalidMidiDataException
    {
        ...
        for (int i = 0; i < tracks.length; i++) {
            ...
            try {
                ...
                instrumentChange.setMessage(ShortMessage.PROGRAM_CHANGE, 0, programChange, -1);
